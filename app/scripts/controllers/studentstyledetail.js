...
/**
 * @ngdoc function
 * @name luZhouApp.controller:StudentstyledetailCtrl
 * @description
 * # StudentstyledetailCtrl
 * Controller of the luZhouApp
 */
angular.module('luZhouApp')
  .controller('StudentstyledetailCtrl', function ($scope, $http, $stateParams, $loading, commonService) {
